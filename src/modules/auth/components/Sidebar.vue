<template>
    <div class="flex w-full h-screen">
      ...
      >
        ...
        <div class="flex items-center justify-between p-4">
          ...
          <button @click="toggle" class="p-1 rounded hover:bg-orange-100">
            ...
            <svg v-else xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-orange-600" fill="none"
              viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="mx-4 my-4">
          <button
            @click="logout()"
            class="flex items-center w-full p-2 rounded-2xl bg-white hover:bg-orange-50 transition"
          >
      ...
      <!-- Contenido principal -->
      <main class="flex-1 bg-[#F9EBD9] min-h-screen overflow-auto">
        <slot />
      </main>
    </div>
  </template>
