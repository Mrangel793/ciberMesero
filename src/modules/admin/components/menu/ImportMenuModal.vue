      ...
      >
        <div class="bg-white rounded-xl max-w-md w-full mx-4 p-6 relative">
          ...
          <p class="text-center text-gray-600 mb-6">
            Para cargar su menú, haga clic en ‘Cargar archivo’, seleccione o arrastre el documento y luego presione el botón ‘Importar’
          </p>
          ...
          >
            ...
            />
            <span class="text-gray-400">{{ fileName || 'Cargar archivo' }}</span>
          </label>
