<template>
  ...
  /** Datos de categoría (podrían venir de API) */
  const categories = ref(['Entradas', 'Hamburguesas', 'Bebidas', 'Postres', 'Bebidas'])
  ...
  function onSubmit() {
    // Puedes empacar form.file y demás en FormData para tu API
    emit('create', { ...form })
    emit('close')
  }
  </script>
