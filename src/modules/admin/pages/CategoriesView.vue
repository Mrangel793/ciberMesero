<template>
    <Sidebar>
        <div class="p-6 min-h-screen bg-[#F9EBD9] space-y-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
                <div v-for="cat in filteredCategories" :key="cat.id"
                    ...
                    <div class="flex gap-3">
                        ...
                        <TrashIcon @click="deleteCategory(cat.id)"
            ...
            <NuevaCategoriaModal :visible="showNewCat" @close="showNewCat = false" @save="handleSaveCategory" />
        </div>
    </Sidebar>
</template>
...
function handleSaveCategory(payload: { name: string }) {
    // Lógica para guardar la nueva categoría (API + actualizar lista local)
